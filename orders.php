...
<section class="orders">
   ...
   <div class="box">
      ...
      <p>Metodo Pago : <span><?= $fetch_orders['method']; ?></span></p>
      <p>Tus Ordenes : <span><?= $fetch_orders['total_products']; ?></span></p>
      <p>Total : <span>$<?= $fetch_orders['total_price']; ?>/-</span></p>
      <p> Estado Pago : <span style="color:<?php if($fetch_orders['payment_status'] == 'pending'){ echo 'red'; }else{ echo 'green'; }; ?>"><?= $fetch_orders['payment_status']; ?></span> </p>
   </div>
   <?php
      }
      }else{
