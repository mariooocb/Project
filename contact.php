...
<section class="contact">
   ...
   <form action="" method="post">
      ...
      <input type="number" name="number" min="0" max="9999999999" placeholder="Numero" required onkeypress="if(this.value.length == 10) return false;" class="box">
      <textarea name="msg" class="box" placeholder="Mensaje" cols="30" rows="10"></textarea>
