...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="text" name="name" value="<?= $fetch_profile['name']; ?>" required placeholder="Nombre" maxlength="20"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
      ...
      <input type="password" name="confirm_pass" placeholder="Contraseña Nueva" maxlength="20"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
