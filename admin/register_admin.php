...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="text" name="name" required placeholder="Nombre" maxlength="20"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
      ...
      <input type="password" name="cpass" required placeholder="Contraseña" maxlength="20"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
